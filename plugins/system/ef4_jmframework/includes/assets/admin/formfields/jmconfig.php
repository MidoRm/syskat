<?php
/**
 * @version $Id: jmconfig.php 71 2015-01-16 09:32:07Z michal $
 * @package JMFramework
    ...
    protected function getInput()
    {
        if (!self::$loaded && defined('JMF_TPL_PATH') && defined('JMF_TPL_URL')) {
            ...
            $html[] = '<div id="jm_config_load" class="control-group">'; 
                $html[] = '<div class="control-label">';
                    $html[] = '<label class="hasTooltip" title="<strong>'.JText::_('PLG_SYSTEM_JMFRAMEWORK_CONFIG_STORAGE_LOAD_LABEL').'</strong><br/>'.JText::_('PLG_SYSTEM_JMFRAMEWORK_CONFIG_STORAGE_LOAD_DESC').'">'.JText::_('PLG_SYSTEM_JMFRAMEWORK_CONFIG_STORAGE_LOAD_LABEL').'</label>';
                $html[] = '</div>';
            ...
            $html[] = '<div id="jm_config_uploadload" class="control-group">'; 
                $html[] = '<div class="control-label">';
                    $html[] = '<label class="hasTooltip" title="<strong>'.JText::_('PLG_SYSTEM_JMFRAMEWORK_CONFIG_STORAGE_UPLOAD_SHORT_LABEL').'</strong><br/>'.JText::_('PLG_SYSTEM_JMFRAMEWORK_CONFIG_STORAGE_UPLOAD_DESC').'">'.JText::_('PLG_SYSTEM_JMFRAMEWORK_CONFIG_STORAGE_UPLOAD_LABEL').'</label>';
                $html[] = '</div>';
                $html[] = '<div class="controls">';
            ...
            $html[] = '<div class="control-group">';
                $html[] = '<div class="control-label">';
                    $html[] = '<div id="jm_config_save" class="input-append">'; 
                        $html[] = '<label class="hasTooltip" title="<strong>'.JText::_('PLG_SYSTEM_JMFRAMEWORK_CONFIG_STORAGE_SAVE_LABEL').'</strong><br/>'.JText::_('PLG_SYSTEM_JMFRAMEWORK_CONFIG_STORAGE_SAVE_DESC').'">'.JText::_('PLG_SYSTEM_JMFRAMEWORK_CONFIG_STORAGE_SAVE_LABEL').'</label>';
                    $html[] = '</div>';
                $html[] = '</div>';
                $html[] = '<div class="controls">';
                    $html[] = '<div id="jm_config_save" class="input-append">'; 
            ...
            $html[] = '<div class="control-group">';
                $html[] = '<div class="control-label">';
                    $html[] = '<label class="hasTooltip" title="<strong>'.JText::_('PLG_SYSTEM_JMFRAMEWORK_CONFIG_STORAGE_STORAGE_LOCATION').'</strong><br/>'.JText::_('PLG_SYSTEM_JMFRAMEWORK_CONFIG_STORAGE_STORAGE_LOCATION_DESC').'">'.JText::_('PLG_SYSTEM_JMFRAMEWORK_CONFIG_STORAGE_STORAGE_LOCATION').'</label>';
                $html[] = '</div>';
                $html[] = '<div class="controls">';
