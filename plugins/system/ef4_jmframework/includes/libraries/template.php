<?php
/**
 * @version $Id: template.php 87 2015-03-18 16:02:35Z michal $
 * @package JMFramework
...
abstract class JMFTemplate {
    ...
    public function getColumnClasses($s, $c, $l, $r) {
        ...
        $class = array('content'=>'', 'left'=>'', 'right'=>'');
        ...
        switch($s) {
            ...
            case 'c':
                ...
                break;
            default:
                $dclass = $this->params->get('class');
                if($dclass['left'] && $dclass['right']) {
