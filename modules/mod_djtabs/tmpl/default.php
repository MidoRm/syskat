...
<div id="<?php echo $mod_prefix; ?>djtabs" class="djtabs <?php echo ($params->get('class_theme_title')); ?>" style="visibility:hidden">

	<div class="tabs-wrapper<?php echo ($params->get('tabs_hidden',2)==1) ? ' tabs-hidden' : ''; ?>">
   <?php   
   if (!$tabs) echo JText::_('COM_DJTABS_NO_TABS');  
   $tab_i = 0;
        foreach($tabs as $tab){ 
        	$tab_i++;
        	?>
        	<div class="djtabs-title-wrapper">
                <div id="<?php echo $mod_prefix; ?>djtab<?php echo $tab_i; ?>" class="djtabs-title <?php echo $mod_prefix; ?>djtabs_help_class">
                	...
                	<span id="<?php echo $mod_prefix; ?>djtabs_title_img_right<?php echo $tab_i; ?>" class="djtabs-title-img-right"></span>
                </div>
            </div>        
        <?php }  ?>        
 ...
 <script>
	...
	window.addEvent('resize', function() {
		resetTabsWidth('<?php echo $mod_prefix; ?>');
		setTabsWidth(<?php echo $params->get('rows_number',1)?>,'<?php echo $mod_prefix; ?>');
  	...
  	window.addEvent('domready', function(){
	   ...
	   new Fx.Accordion(document.id('<?php echo $mod_prefix; ?>djtabs'), '#<?php echo $mod_prefix; ?>djtabs .djtabs-title', '#<?php echo $mod_prefix; ?>djtabs .djtabs-body',
	   {
