 ...
 * @author GraphicAholic <support@graphicaholic.com>
 *
 */
...
class phpPicasahelper {
    ...
    private function getUrlContent()
	{
         ...
         *
         */
        public function getAlbums($userid,$thumbsize="") {
            $albums=array();
            $this->userid=$userid;
         ...
         *
         */
        public function getPictures($userid,$albumid,$caption,$thumbsize="",$picturesize="") {
