    ...
    public static function api($posts, $returnUrl = false) {
        ...
        if (class_exists('JHttp')) {
            ...
            if (!$response || $response->code != '200') {
                N2Message::error(n2_('Unable to contact with the licensing server. Possible reasons might be the CURL not enabled in php.ini, call to remote url(secure.nextenedweb.com) is disabled on your server.'));
                return array(
